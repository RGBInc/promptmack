  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl mt-16">
      ...
      <div className="prose dark:prose-invert">
        ...
        <p className="mb-6">Our Business Terms govern use of Promptmack Enterprise, our APIs, and our other services for businesses and developers.</p>

        <p className="mb-6">Our Privacy Policy explains how we collect and use personal information. Although it does not form part of these Terms, it is an important document that you should read.</p>

        <h2 className="text-xl font-semibold mt-8 mb-4">Who We Are</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4">Using Our Services</h2>
        ...
        <p className="mb-4">Represent that Output was human-generated when it was not.</p>
        <p className="mb-4">Interfere with or disrupt our Services, including circumvent any rate limits or restrictions.</p>
        ...
        <p className="mb-6">We may update these Terms from time to time to reflect changes to the law, regulatory requirements, security or safety reasons, or circumstances beyond our reasonable control. We will give you at least 30 days advance notice of changes to these Terms that materially adversely impact you either via email or an in-product notification. All other changes will be effective as soon as we post them to our website. If you do not agree to the changes, you must stop using our Services.</p>

        <h2 className="text-xl font-semibold mt-8 mb-4">Governing Law</h2>
        <p className="mb-6">California law will govern these Terms except for its conflicts of laws principles. All claims arising out of or relating to these Terms will be brought exclusively in the federal or state courts of San Francisco, California.</p>

        <h2 className="text-xl font-semibold mt-8 mb-4">Contact Information</h2>
        <p className="mb-6">For questions about these terms or to report violations, please contact us at:<br />
