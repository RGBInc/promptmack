      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {newsData.news.map((item, index) => (
          <motion.div
            ...
            className="flex flex-col gap-3 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:bg-zinc-100 dark:hover:bg-zinc-800/80 hover:border-zinc-300 dark:hover:border-zinc-600"
          >
            <div className="flex gap-4">
              <div className="flex-1">
                <a
